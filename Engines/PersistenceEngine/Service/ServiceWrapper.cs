...
namespace Charon.Engines.PersistenceEngine
{
    public partial class ServiceWrapper : ServiceBase
    {
        ...
        private Engine _persistenceEngine;
        ...
        {
            _logger.Log(LogLevel.Info,"Starting PersistenceEngine Service");
            ...
            //Initialise Persistence Engine
            _persistenceEngine = new Engine();
        ...
        protected override void OnStop()
        {
            ...
            _logger.Log(LogLevel.Info, "Stopping PersistenceEngine Service");
